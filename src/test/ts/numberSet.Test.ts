...
import { NumberSet, DistributionEnum } from "../../main/ts/NumberSet.ts";

describe("Integer Set", ()=>{
    //Arrange, Act, Assert
    let intSet: Array<number> = [];
    it("Generate nothing", ()=>{
        intSet = new NumberSet(0, DistributionEnum.RAND);
    })
...
describe("Set of 10 random integers", ()=>{
    ...
    it("Generates a set of 10 values", ()=>{
        intSet = new NumberSet(10, DistributionEnum.RAND, 5).numbers;
    })
...
describe("Set of 20 normal integers", ()=>{
    ...
    it("Generate a set of 10 values", ()=>{
        intSet = new NumberSet(20, DistributionEnum.NORMAL, 5, 4).numbers;
    })
    test(`Set {${intSet.toString()}} has 10 entries`, ()=>{
...
describe("Set of 500 normal integers", ()=>{
    ...
    it("Has a distribution of (0,1)", ()=>{
        intSet = new NumberSet(500, DistributionEnum.NORMAL).numbers;
    })
    test("500 values", ()=>{
...
describe("Integer Set exception handling", ()=>{
    it("Has an invalid distribution", ()=>{
        ...
        test("And throws an error", ()=>{
            assert.throws(()=>{
                intSet = new NumberSet(12, "Strange", 18, 5).numbers;
